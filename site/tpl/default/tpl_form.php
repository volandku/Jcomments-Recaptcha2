...
<a id="addcomments" class="showform" data-object_id="<?php echo $object_id; ?>" data-object_group"<?php echo $object_group; ?>" href="#addcomments"  ><?php echo JText::_('FORM_HEADER'); ?></a>
</div>
<?php
	}
